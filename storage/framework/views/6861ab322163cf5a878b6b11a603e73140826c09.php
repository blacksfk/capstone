                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6" data-scroll-reveal="enter from the bottom after 0.6s">
                                    <div class="about-div">
                                        ...
                                        <p>
                                        attractive grounds and gardens<br>
                                        substantial shade areas<br>
                                        grade level adventure playgrounds<br>
                                        Prep rotunda<br>
                                        Two hard-court areas and a large oval<br>
                                        fully serviced canteen<br>
                                        two computer labs with modern equipment<br>
                                        travelling laptop program<br>
                                        a purpose built 'state-of-the-art' Multimedia/TV studio<br>
                                        full-sized and fully equipped gymnasium<br>
                                        Performing Arts Centre<br>
                                        New Music Room<br>
                                        Art Room<br>
                                        Fully stocked library with internet search stations   
                                        </p>
                                    </div>
                                </div>
                            </div>
